...
type conn interface {
	driver.Pinger
	driver.Execer //nolint:staticcheck,nolintlint
	driver.ExecerContext
	driver.Queryer //nolint:staticcheck,nolintlint
...
func WrapDriverByName(driverName string, wrapper Hook, conn AfterConnQuery) (string, error) {
	...
	return "", errors.New(
		"unable to register driver, all slots have been taken. You might want to increase `maxWrappedDriversCount`", //nolint:lll
	)
}
